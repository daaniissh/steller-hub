      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <nav>  <AnimatePage initial={{ opacity: 0 ,x:-50}} animate={{ opacity: 2,x:0 }} exit={{ opacity: 0,x:50 }} transition={{
            ...
            <div className="select-none badge border-lime-300">{country}</div>
              <li className='w-5 h-5 animate-bounce cursor-pointer' >
                <a href="https://www.instagram.com/steller_hub2.0/reels/" className="text-white  "><img src="/instagram.png" alt="" /></a>
              </li>
